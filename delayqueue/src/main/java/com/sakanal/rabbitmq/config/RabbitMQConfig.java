...
public class RabbitMQConfig {
    ...
    public DirectExchange xExchange(){
        return new DirectExchange(X_EXCHANGE,false,true);
    }
    @Bean("yExchange")
    public DirectExchange yExchange(){
        return new DirectExchange(Y_DEAD_LETTER_EXCHANGE,false,true);
    }
    ...
    @Bean("queueD")
    public Queue queueD(){
        return QueueBuilder.durable(DEAD_LATTER_QUEUE)
                .build();
    }
